                    ...
                    <div class="card-text">
                        <form method="post">
                            <div class="form-group">
                                <label>Código:</label>
                                <input type="text" class="form-control" disabled="disabled" value="<?=$data['usuarios']['email'];var_dump($data) ?>">
                                <input name="idUsuario" type="hidden" value="<?=$data['usuarios']['id_usuario']; var_dump($data)?>">
                            </div>
                            <div class="form-group">
                                <label>missao:</label>
                                <input type="text" class="form-control" id="missao" name="missao" value="<?=$data['usuarios']['id_usuario']?>">
                                <?php if (isset($data['erro']['id_usuario'])):?>
                                    <div style="color: darkred;"><b><?=$data['erro']['id_usuario']?></b></div>
                                <?php endif ?>
                            </div>
                            <div class="form-group">
                                <label>materia:</label>
                            ...
                            <button type="submit" class="btn btn-primary" name="alterarUsuario" id="alterarUsario">salvar</button>
                        </form>
